...
public class AuthRoutesTests extends BasicTest {
    ...
    public void forbitsVisitsToHomeUrlIfNotAuthenticated(){
    ...
    public void forbitsVisitsToProfileUrlIfNotAuthenticated(){
    ...
    public void forbitsVisitsToAdminCitiesUrlIfNotAuthenticated(){
    ...
    public void forbitsVisitsToAdminCUsersUrlIfNotAuthenticated(){
